    ...
    public class SysTrayWnd
    {
        public struct TrayItemData
        {
            ...
            public string processName
            {
                get
                {
                    Process myProcess = Process.GetProcessById(dwProcessID);
        ...
        public static IntPtr GetOverflowTrayWnd()
        {
            IntPtr handle = Win32.FindWindow("NotifyIconOverflowWindow", null);
            handle = Win32.FindWindowEx(handle, IntPtr.Zero, "ToolbarWindow32", null);
            return handle;
        }
        ...
        public static TrayItemData[] GetTrayWndDetail(IntPtr hTrayWnd)
        {
